...
const styles = StyleSheet.create({
  ...
  submitBtn: { backgroundColor: colors.gold, borderRadius: 8, paddingVertical: 14, marginTop: 24, alignItems: "center" },
  ...
  altBtn: { borderWidth: 1, borderColor: colors.gold, borderRadius: 8, paddingVertical: 14, alignItems: "center" },
  altBtnText: { color: colors.gold, fontWeight: "700" },
