...
const styles = StyleSheet.create({
  ...
  submitBtn: { backgroundColor: colors.gold, borderRadius: 8, paddingVertical: 14, marginTop: 18, alignItems: "center" },
  submitBtnText: { color: colors.textOnGold, fontWeight: "700" },
  divider: { alignItems: "center", marginVertical: 18 },
  orText: { color: colors.textDim },
  createBtn: { borderWidth: 1, borderColor: colors.gold, borderRadius: 8, paddingVertical: 14, alignItems: "center" },
  createBtnText: { color: colors.gold, fontWeight: "700" },
